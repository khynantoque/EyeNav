...
public class PendingIntentReceiver extends BroadcastReceiver {
	...
	/* package */ static final String ACTION = "com.khynsoft.ble.ACTION_FOUND";
	/* package */ static final String EXTRA_PENDING_INTENT = "com.khynsoft.ble.EXTRA_PENDING_INTENT";
	/* package */ static final String EXTRA_FILTERS = "com.khynsoft.ble.EXTRA_FILTERS";
	/* package */ static final String EXTRA_SETTINGS = "com.khynsoft.ble.EXTRA_SETTINGS";
	/* package */ static final String EXTRA_USE_HARDWARE_BATCHING = "com.khynsoft.ble.EXTRA_USE_HARDWARE_BATCHING";
	/* package */ static final String EXTRA_USE_HARDWARE_FILTERING = "com.khynsoft.ble.EXTRA_USE_HARDWARE_FILTERING";
	/* package */ static final String EXTRA_USE_HARDWARE_CALLBACK_TYPES = "com.khynsoft.ble.EXTRA_USE_HARDWARE_CALLBACK_TYPES";
	/* package */ static final String EXTRA_MATCH_LOST_TIMEOUT = "com.khynsoft.ble.EXTRA_MATCH_LOST_TIMEOUT";
	/* package */ static final String EXTRA_MATCH_LOST_INTERVAL = "com.khynsoft.ble.EXTRA_MATCH_LOST_INTERVAL";
	/* package */ static final String EXTRA_MATCH_MODE = "com.khynsoft.ble.EXTRA_MATCH_MODE";
	/* package */ static final String EXTRA_NUM_OF_MATCHES = "com.khynsoft.ble.EXTRA_NUM_OF_MATCHES";
